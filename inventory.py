...
from tkinter import messagebox, ttk, HORIZONTAL, VERTICAL, RIGHT, Y, BOTTOM, X, W, NO
...
class Widgets:
    def __init__(self,master):
        ...
        self.inventory_box = ttk.Treeview(frame_inventory_list,columns=("ProductID","Product Name","Product Qty","Product Price"),selectmode='extended')
        ...
        self.inventory_box.column('#1', stretch = 'no',minwidth=0,width=20)
        self.inventory_box.column('#2', stretch='no', minwidth=0, width=120)
        self.inventory_box.column('#3', stretch='no', minwidth=0, width=120)
        self.inventory_box.column('#4', stretch='no', minwidth=0, width=120)
        self.inventory_box.place(relx=0, rely=0.1, relheight=1, relwidth=1)
        self.DisplayData()


        self.search_bar = tk.Entry(frame_other_widgets, font=25)
        ...
        self.search_button = tk.Button(frame_other_widgets, text="Search",
                                  command=lambda: get_search_entry(search_bar.get()))
        ...
        self.delete_button = tk.Button(frame_other_widgets, text="Delete",
                                       )
